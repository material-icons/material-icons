...
All missing icons are available in "master" branch of this repository. You are currently browsing "original" branch that contains only official Google icons, "master" branch contains icons were not updated by Google team and few custom icons.
